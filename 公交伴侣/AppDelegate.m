...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    BOOL ret = [_mapManager start:@"s9lZEPTmQqGFEIGs088AixFVHcacG2ZN" generalDelegate:self];
    if (!ret) {
...
- (void)applicationWillTerminate:(UIApplication *)application {
    ...
    [city.currentCityName writeToFile:newPath atomically:YES encoding:NSUTF8StringEncoding error:nil];
}
